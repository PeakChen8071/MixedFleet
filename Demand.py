...
from Basics import np, Events, distance_between, Location
...
class Passenger:
    ...
    def __init__(self, time, origin, destination, trip_distance, trip_duration, patience=60):
        ...
        self.preferredCar, self.fare = Passenger.choose_vehicle(self)
    ...
    def choose_vehicle(self):
        ...
        GC_HV = fare_HV + valueOfTime * Variables.phiHV * self.nearest_vehicle(HV.HV_v.values())
        GC_AV = fare_AV + valueOfTime * Variables.phiAV * self.nearest_vehicle(AV.AV_v.values())
